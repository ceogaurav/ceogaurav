    ...
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Calculate your car loan EMI and drive your dream car</p>
        </div>
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{tenureInYears} years {remainingMonths > 0 && `${remainingMonths} months`}</span>
                </div>
                <div className="flex justify-between">
        ...
        {/* Car Loan Tips */}
        <div className="mt-12">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">Car Loan Tips</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🚗</span>
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">New vs Used</h3>
              <p className="text-gray-600">New cars get better interest rates than used cars</p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600">Higher down payment reduces EMI burden</p>
            </div>
            ...
            <div className="card text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Compare Rates</h3>
              <p className="text-gray-600">Compare interest rates from multiple lenders</p>
            </div>
            ...
            <div className="card text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Prepayment</h3>
              <p className="text-gray-600">Consider prepayment to reduce total interest</p>
            </div>
          </div>
        </div>
      </div>
